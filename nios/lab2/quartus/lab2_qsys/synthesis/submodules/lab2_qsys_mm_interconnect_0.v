...
`timescale 1 ps / 1 ps
module lab2_qsys_mm_interconnect_0 (
		...
		input  wire [14:0] nios2_qsys_data_master_address,               //                 nios2_qsys_data_master.address
		...
		input  wire [14:0] nios2_qsys_instruction_master_address,        //          nios2_qsys_instruction_master.address
	...
	wire  [14:0] nios2_qsys_data_master_translator_avalon_universal_master_0_address;              // nios2_qsys_data_master_translator:uav_address -> nios2_qsys_data_master_agent:av_address
	...
	wire  [88:0] rsp_mux_src_data;                                                                 // rsp_mux:src_data -> nios2_qsys_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                                // nios2_qsys_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [3:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> nios2_qsys_data_master_agent:rp_channel
	...
	wire  [14:0] nios2_qsys_instruction_master_translator_avalon_universal_master_0_address;       // nios2_qsys_instruction_master_translator:uav_address -> nios2_qsys_instruction_master_agent:av_address
	...
	wire  [88:0] rsp_mux_001_src_data;                                                             // rsp_mux_001:src_data -> nios2_qsys_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                            // nios2_qsys_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [3:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> nios2_qsys_instruction_master_agent:rp_channel
	...
	wire  [14:0] nios2_qsys_debug_mem_slave_agent_m0_address;                                      // nios2_qsys_debug_mem_slave_agent:m0_address -> nios2_qsys_debug_mem_slave_translator:uav_address
	...
	wire  [89:0] nios2_qsys_debug_mem_slave_agent_rf_source_data;                                  // nios2_qsys_debug_mem_slave_agent:rf_source_data -> nios2_qsys_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [89:0] nios2_qsys_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2_qsys_debug_mem_slave_agent_rsp_fifo:out_data -> nios2_qsys_debug_mem_slave_agent:rf_sink_data
	...
	wire         cmd_mux_src_valid;                                                                // cmd_mux:src_valid -> nios2_qsys_debug_mem_slave_agent:cp_valid
	wire  [88:0] cmd_mux_src_data;                                                                 // cmd_mux:src_data -> nios2_qsys_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                                // nios2_qsys_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [3:0] cmd_mux_src_channel;                                                              // cmd_mux:src_channel -> nios2_qsys_debug_mem_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                        // cmd_mux:src_startofpacket -> nios2_qsys_debug_mem_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                          // cmd_mux:src_endofpacket -> nios2_qsys_debug_mem_slave_agent:cp_endofpacket
	...
	wire  [88:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> onchip_mem_s1_agent:cp_data
	...
	wire  [14:0] led_s1_agent_m0_address;                                                          // led_s1_agent:m0_address -> led_s1_translator:uav_address
	...
	wire  [89:0] led_s1_agent_rf_source_data;                                                      // led_s1_agent:rf_source_data -> led_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] led_s1_agent_rsp_fifo_out_data;                                                   // led_s1_agent_rsp_fifo:out_data -> led_s1_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_002_src_data;                                                             // cmd_mux_002:src_data -> led_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                            // led_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> led_s1_agent:cp_channel
	...
	wire  [14:0] buttons_s1_agent_m0_address;                                                      // buttons_s1_agent:m0_address -> buttons_s1_translator:uav_address
	...
	wire  [89:0] buttons_s1_agent_rf_source_data;                                                  // buttons_s1_agent:rf_source_data -> buttons_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] buttons_s1_agent_rsp_fifo_out_data;                                               // buttons_s1_agent_rsp_fifo:out_data -> buttons_s1_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> buttons_s1_agent:cp_data
	...
	wire  [88:0] nios2_qsys_data_master_agent_cp_data;                                             // nios2_qsys_data_master_agent:cp_data -> router:sink_data
	...
	wire  [88:0] nios2_qsys_instruction_master_agent_cp_data;                                      // nios2_qsys_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire         nios2_qsys_debug_mem_slave_agent_rp_valid;                                        // nios2_qsys_debug_mem_slave_agent:rp_valid -> router_002:sink_valid
	wire  [88:0] nios2_qsys_debug_mem_slave_agent_rp_data;                                         // nios2_qsys_debug_mem_slave_agent:rp_data -> router_002:sink_data
	wire         nios2_qsys_debug_mem_slave_agent_rp_ready;                                        // router_002:sink_ready -> nios2_qsys_debug_mem_slave_agent:rp_ready
	wire         nios2_qsys_debug_mem_slave_agent_rp_startofpacket;                                // nios2_qsys_debug_mem_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         nios2_qsys_debug_mem_slave_agent_rp_endofpacket;                                  // nios2_qsys_debug_mem_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [88:0] onchip_mem_s1_agent_rp_data;                                                      // onchip_mem_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [88:0] led_s1_agent_rp_data;                                                             // led_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [88:0] buttons_s1_agent_rp_data;                                                         // buttons_s1_agent:rp_data -> router_005:sink_data
	...
	wire         nios2_qsys_debug_mem_slave_agent_rdata_fifo_src_valid;                            // nios2_qsys_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] nios2_qsys_debug_mem_slave_agent_rdata_fifo_src_data;                             // nios2_qsys_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         nios2_qsys_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter:in_0_ready -> nios2_qsys_debug_mem_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                    // avalon_st_adapter:out_0_valid -> nios2_qsys_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                     // avalon_st_adapter:out_0_data -> nios2_qsys_debug_mem_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                    // nios2_qsys_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                    // avalon_st_adapter:out_0_error -> nios2_qsys_debug_mem_slave_agent:rdata_fifo_sink_error
	...
	wire         led_s1_agent_rdata_fifo_src_valid;                                                // led_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] led_s1_agent_rdata_fifo_src_data;                                                 // led_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         led_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_002:in_0_ready -> led_s1_agent:rdata_fifo_src_ready
	...
	lab2_qsys_mm_interconnect_0_router router (
	...
	lab2_qsys_mm_interconnect_0_router router_001 (
	...
	lab2_qsys_mm_interconnect_0_router_002 router_002 (
	...
	lab2_qsys_mm_interconnect_0_router_002 router_003 (
	...
	lab2_qsys_mm_interconnect_0_router_002 router_004 (
	...
	lab2_qsys_mm_interconnect_0_router_002 router_005 (
	...
	lab2_qsys_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
