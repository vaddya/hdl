...
`timescale 1 ps / 1 ps
module lab1_qsys_mm_interconnect_0 (
	...
	wire  [86:0] rsp_mux_src_data;                                                                 // rsp_mux:src_data -> nios2_qsys_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                                // nios2_qsys_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [1:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> nios2_qsys_data_master_agent:rp_channel
	...
	wire  [86:0] rsp_mux_001_src_data;                                                             // rsp_mux_001:src_data -> nios2_qsys_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                            // nios2_qsys_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [1:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> nios2_qsys_instruction_master_agent:rp_channel
	...
	wire  [87:0] onchip_mem_s1_agent_rf_source_data;                                               // onchip_mem_s1_agent:rf_source_data -> onchip_mem_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] onchip_mem_s1_agent_rsp_fifo_out_data;                                            // onchip_mem_s1_agent_rsp_fifo:out_data -> onchip_mem_s1_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_src_data;                                                                 // cmd_mux:src_data -> onchip_mem_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                                // onchip_mem_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                              // cmd_mux:src_channel -> onchip_mem_s1_agent:cp_channel
	...
	wire  [87:0] pio_s1_agent_rf_source_data;                                                      // pio_s1_agent:rf_source_data -> pio_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] pio_s1_agent_rsp_fifo_out_data;                                                   // pio_s1_agent_rsp_fifo:out_data -> pio_s1_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                            // cmd_mux_001:src_valid -> pio_s1_agent:cp_valid
	wire  [86:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> pio_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                            // pio_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> pio_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                    // cmd_mux_001:src_startofpacket -> pio_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                      // cmd_mux_001:src_endofpacket -> pio_s1_agent:cp_endofpacket
	wire         nios2_qsys_data_master_agent_cp_valid;                                            // nios2_qsys_data_master_agent:cp_valid -> router:sink_valid
	wire  [86:0] nios2_qsys_data_master_agent_cp_data;                                             // nios2_qsys_data_master_agent:cp_data -> router:sink_data
	...
	wire  [86:0] router_src_data;                                                                  // router:src_data -> cmd_demux:sink_data
	...
	wire  [86:0] nios2_qsys_instruction_master_agent_cp_data;                                      // nios2_qsys_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [86:0] onchip_mem_s1_agent_rp_data;                                                      // onchip_mem_s1_agent:rp_data -> router_002:sink_data
	...
	wire         pio_s1_agent_rp_valid;                                                            // pio_s1_agent:rp_valid -> router_003:sink_valid
	wire  [86:0] pio_s1_agent_rp_data;                                                             // pio_s1_agent:rp_data -> router_003:sink_data
	wire         pio_s1_agent_rp_ready;                                                            // router_003:sink_ready -> pio_s1_agent:rp_ready
	wire         pio_s1_agent_rp_startofpacket;                                                    // pio_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         pio_s1_agent_rp_endofpacket;                                                      // pio_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [86:0] cmd_demux_001_src0_data;                                                          // cmd_demux_001:src0_data -> cmd_mux:sink1_data
	...
	wire  [86:0] cmd_demux_001_src1_data;                                                          // cmd_demux_001:src1_data -> cmd_mux_001:sink1_data
	...
	wire  [86:0] rsp_demux_src1_data;                                                              // rsp_demux:src1_data -> rsp_mux_001:sink0_data
	...
	wire  [86:0] rsp_demux_001_src1_data;                                                          // rsp_demux_001:src1_data -> rsp_mux_001:sink1_data
	...
	wire         pio_s1_agent_rdata_fifo_src_valid;                                                // pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] pio_s1_agent_rdata_fifo_src_data;                                                 // pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         pio_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_001:in_0_ready -> pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                // avalon_st_adapter_001:out_0_valid -> pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                 // avalon_st_adapter_001:out_0_data -> pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                // pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                // avalon_st_adapter_001:out_0_error -> pio_s1_agent:rdata_fifo_sink_error
	...
	lab1_qsys_mm_interconnect_0_router router (
	...
	lab1_qsys_mm_interconnect_0_router router_001 (
	...
	lab1_qsys_mm_interconnect_0_router_002 router_002 (
	...
	lab1_qsys_mm_interconnect_0_router_002 router_003 (
	...
	lab1_qsys_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_qsys_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_qsys_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_qsys_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_qsys_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_qsys_mm_interconnect_0_cmd_demux rsp_demux_001 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_qsys_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_qsys_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab1_qsys_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
