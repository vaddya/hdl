...
module lab2_qsys_mm_interconnect_0 (
	...
	wire  [90:0] rsp_mux_src_data;                                                                 // rsp_mux:src_data -> nios2_qsys_data_master_agent:rp_data
	...
	wire  [90:0] rsp_mux_001_src_data;                                                             // rsp_mux_001:src_data -> nios2_qsys_instruction_master_agent:rp_data
	...
	wire  [91:0] nios2_qsys_debug_mem_slave_agent_rf_source_data;                                  // nios2_qsys_debug_mem_slave_agent:rf_source_data -> nios2_qsys_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [91:0] nios2_qsys_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2_qsys_debug_mem_slave_agent_rsp_fifo:out_data -> nios2_qsys_debug_mem_slave_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> nios2_qsys_debug_mem_slave_agent:cp_data
	...
	wire  [91:0] onchip_mem_s1_agent_rf_source_data;                                               // onchip_mem_s1_agent:rf_source_data -> onchip_mem_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] onchip_mem_s1_agent_rsp_fifo_out_data;                                            // onchip_mem_s1_agent_rsp_fifo:out_data -> onchip_mem_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_002_src_data;                                                             // cmd_mux_002:src_data -> onchip_mem_s1_agent:cp_data
	...
	wire  [91:0] led_s1_agent_rf_source_data;                                                      // led_s1_agent:rf_source_data -> led_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] led_s1_agent_rsp_fifo_out_data;                                                   // led_s1_agent_rsp_fifo:out_data -> led_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> led_s1_agent:cp_data
	...
	wire  [91:0] buttons_s1_agent_rf_source_data;                                                  // buttons_s1_agent:rf_source_data -> buttons_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] buttons_s1_agent_rsp_fifo_out_data;                                               // buttons_s1_agent_rsp_fifo:out_data -> buttons_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> buttons_s1_agent:cp_data
	...
	wire  [90:0] nios2_qsys_data_master_agent_cp_data;                                             // nios2_qsys_data_master_agent:cp_data -> router:sink_data
	...
	wire  [90:0] nios2_qsys_instruction_master_agent_cp_data;                                      // nios2_qsys_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [90:0] nios2_qsys_debug_mem_slave_agent_rp_data;                                         // nios2_qsys_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [90:0] onchip_mem_s1_agent_rp_data;                                                      // onchip_mem_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [90:0] led_s1_agent_rp_data;                                                             // led_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [90:0] buttons_s1_agent_rp_data;                                                         // buttons_s1_agent:rp_data -> router_006:sink_data
	...
	lab2_qsys_mm_interconnect_0_router_001 router_001 (
	...
	lab2_qsys_mm_interconnect_0_router_003 router_003 (
	...
	lab2_qsys_mm_interconnect_0_router_003 router_004 (
	...
	lab2_qsys_mm_interconnect_0_router_003 router_005 (
	...
	lab2_qsys_mm_interconnect_0_router_003 router_006 (
	...
	lab2_qsys_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2_qsys_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
